...
export function WorkoutDetailsClient({ sessionId }: { sessionId: UUID }) {
  ...
  useEffect(() => {
    ...
    fetchWorkoutSessionById(sessionId)
      ...
      .catch((caught) => {
        if (!cancelled) {
          setError(caught instanceof Error ? caught.message : "Unable to load workout.");
        }
      });
  ...
  if (!session) {
    return <p className="py-8 text-center text-sm text-neutral-500">Loading workout…</p>;
  }
    ...
    <div className="space-y-4 pb-8">
      <section className="gc-card p-5 sm:p-6">
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          ...
          <div className="gc-stat">
            ...
            <span className="text-[11px] text-neutral-500">sets</span>
          </div>
        </div>
        ...
        <div className="mt-4 rounded-2xl border border-white/[0.07] bg-white/[0.025] p-3">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-bold">Compared with your previous workout</p>
          </div>
          <div className="mt-3 grid grid-cols-2 gap-2 text-center sm:grid-cols-4">
            <div className="rounded-xl bg-emerald-400/[0.08] p-2.5">
              ...
              <span className="text-[10px] font-semibold text-emerald-200/80">improved</span>
            </div>
            <div className="rounded-xl bg-white/[0.045] p-2.5">
              ...
              <span className="text-[10px] font-semibold text-neutral-400">matched</span>
            </div>
            <div className="rounded-xl bg-amber-300/[0.07] p-2.5">
              ...
              <span className="text-[10px] font-semibold text-amber-100/70">adjusted</span>
            </div>
            <div className="rounded-xl bg-indigo-300/[0.08] p-2.5">
              ...
              <span className="text-[10px] font-semibold text-indigo-100/70">new baseline</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-[18px] border border-red-400/15 bg-red-400/[0.035] p-4">
        ...
        <p className="mb-3 mt-1 text-sm leading-6 text-neutral-500">
          Delete accidental test sessions so they do not affect your history or analytics.
        </p>

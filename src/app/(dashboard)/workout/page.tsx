      ...
      <PageContainer className="space-y-4 pb-8 pt-5">
        ...
        >
          ...
          <div className="relative flex items-start gap-4">
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="mt-1 block text-2xl font-bold tracking-[-0.035em] sm:text-3xl">Today&apos;s workout</span>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <Link href="/workout/active" className="gc-card-interactive flex items-center gap-3 p-4">
            ...
            <span className="min-w-0 flex-1"><span className="block font-bold">Active session</span><span className="block text-sm text-neutral-500">Continue what you started</span></span>
          ...
          <Link href="/workout/history" className="gc-card-interactive flex items-center gap-3 p-4">
            ...
            <span className="min-w-0 flex-1"><span className="block font-bold">Workout history</span><span className="block text-sm text-neutral-500">Review sets and notes</span></span>
            <ArrowUpRight className="h-4 w-4 text-neutral-600" />
          </Link>
          <Link href="/split/personal" className="gc-card-interactive flex items-center gap-3 p-4">
            ...
            <span className="min-w-0 flex-1"><span className="block font-bold">Personal split</span><span className="block text-sm text-neutral-500">Exercises and rest days</span></span>
            <ArrowUpRight className="h-4 w-4 text-neutral-600" />
          </Link>
          <div className="gc-card flex items-center gap-3 p-4 opacity-60">
            ...
            <span><span className="block font-bold">Training calendar</span><span className="block text-sm text-neutral-500">Coming after v1 launch</span></span>
          </div>
        </div>
      </PageContainer>
    </>

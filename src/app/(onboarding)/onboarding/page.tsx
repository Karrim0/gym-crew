...
export default function OnboardingPage() {
  return (
    <div>
      ...
      <h1 className="mt-2 text-3xl font-bold tracking-[-0.04em]">How do you want to train?</h1>
      ...
      <div className="mt-7 space-y-3">
        ...
        <Link href="/create-group" className="gc-card-interactive flex items-center gap-4 p-4">
          ...
          <span className="min-w-0 flex-1">
            <span className="block font-bold">Create a crew</span>
        ...
        <Link href="/join-group" className="gc-card-interactive flex items-center gap-4 p-4">
          ...
          <span className="min-w-0 flex-1">
            <span className="block font-bold">Join with a code</span>

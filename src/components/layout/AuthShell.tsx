...
export function AuthShell({ children }: AuthShellProps) {
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-8 sm:px-6">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_15%_15%,rgba(183,255,60,.12),transparent_25rem),radial-gradient(circle_at_90%_80%,rgba(16,185,129,.08),transparent_28rem)]" />
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-white/[0.08] bg-[#0d110e]/92 shadow-[0_35px_100px_rgba(0,0,0,.55)] backdrop-blur-2xl lg:grid-cols-[1.05fr_.95fr]">
        <section className="hidden min-h-[640px] flex-col justify-between border-r border-white/[0.07] bg-[linear-gradient(145deg,rgba(183,255,60,.12),rgba(255,255,255,.025))] p-10 lg:flex">
          <div>
            <div className="flex items-center gap-3">
              <span className="grid h-12 w-12 place-items-center rounded-2xl bg-lime-300 text-neutral-950">
                <Dumbbell className="h-6 w-6" />
              </span>
              <div>
                <p className="text-xl font-black tracking-[-0.03em]">{APP_CONFIG.name}</p>
                <p className="gc-eyebrow mt-0.5">Train. Track. Repeat.</p>
              </div>
            </div>
            <h2 className="mt-20 max-w-md text-5xl font-black leading-[1.02] tracking-[-0.055em]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-2xl border border-white/[0.08] bg-black/15 p-4">
              <WifiOff className="h-5 w-5 text-lime-300" />
              <p className="mt-3 font-black">Offline first</p>
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-black/15 p-4">
              ...
              <p className="mt-3 font-black">Private by default</p>
        ...
        <section className="flex min-h-[600px] items-center p-5 sm:p-8 lg:p-10">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8 flex items-center gap-3 lg:hidden">
              <span className="grid h-11 w-11 place-items-center rounded-2xl bg-lime-300 text-neutral-950">
                <Dumbbell className="h-5 w-5" />
              </span>
              <div>
                <p className="text-lg font-black">{APP_CONFIG.name}</p>
